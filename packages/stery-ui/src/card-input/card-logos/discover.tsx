export default function discover(props: any) {
  return (
    <svg
      ...
      viewBox="0 0 220.56734 36.535367"
      version="1.1"
      id="svg2"
      {...props}
    >
      <defs id="defs6">
        <clipPath id="clipPath18" clipPathUnits="userSpaceOnUse">
          <path
            id="path20"
            d="m 0,0 1766.57,0 0,479 L 0,479 0,0 Z"
        ...
        <clipPath id="clipPath70" clipPathUnits="userSpaceOnUse">
          <path
            id="path72"
            d="M 0,0 0,479 1767,479 1767,0 0,0 Z"
            inkscape:connector-curvature="0"
          />
        </clipPath>
          ...
          <g id="g14">
            <g clip-path="url(#clipPath18)" id="g16">
              ...
              <path
                ...
                fillRule="nonzero"
                stroke="none"
                d="m 256.938,191.832 54.4648,0 0,279.223 -54.4648,0 0,-279.223 z"
                inkscape:connector-curvature="0"
              />
              <path
                id="path26"
              ...
              <path
                ...
                fillRule="nonzero"
                stroke="none"
                d="m 542.074,331.25 c 0,-82.074 64.446,-145.715 147.383,-145.715 23.445,0 43.523,4.61 68.285,16.274 l 0,64.113 c -21.773,-21.793 -41.058,-30.582 -65.754,-30.582 -54.851,0 -93.785,39.769 -93.785,96.312 0,53.61 40.164,95.899 91.254,95.899 25.977,0 45.641,-9.27 68.285,-31.418 l 0,64.082 c -23.906,12.129 -43.566,17.152 -67,17.152 -82.515,0 -148.668,-64.929 -148.668,-146.117"
                inkscape:connector-curvature="0"
              />
              <path
                id="path30"
                ...
                fillRule="nonzero"
                stroke="none"
                d="m 1189.59,283.5 -74.46,187.555 -59.5,0 118.49,-286.387 29.31,0 120.63,286.387 -59.04,0 -75.43,-187.555"
                inkscape:connector-curvature="0"
              />
              <path
                id="path32"
                ...
                fillRule="nonzero"
                stroke="none"
                d="m 1348.69,191.832 154.46,0 0,47.27 -100.04,0 0,75.371 96.35,0 0,47.297 -96.35,0 0,61.976 100.04,0 0,47.309 -154.46,0 0,-279.223"
                inkscape:connector-curvature="0"
              />
              <path
                id="path34"
                ...
                fillRule="nonzero"
                stroke="none"
                d="m 1609.53,342.504 -15.91,0 0,84.57 16.77,0 c 33.92,0 52.36,-14.211 52.36,-41.386 0,-28.071 -18.44,-43.184 -53.22,-43.184 z m 109.27,46.117 c 0,52.274 -36.01,82.434 -98.82,82.434 l -80.76,0 0,-279.223 54.4,0 0,112.168 7.1,0 75.39,-112.168 66.98,0 -87.9,117.633 c 41.02,8.34 63.61,36.402 63.61,79.156"
                inkscape:connector-curvature="0"
              />
              <path
                id="path36"
                ...
                fillRule="nonzero"
                stroke="none"
                d="m 1743.24,457.211 -0.99,0 0,6.414 1.05,0 c 2.9,0 4.4,-1.043 4.4,-3.156 0,-2.172 -1.52,-3.258 -4.46,-3.258 z m 10.32,3.348 c 0,4.894 -3.37,7.57 -9.29,7.57 l -7.88,0 0,-24.543 5.86,0 0,9.519 6.87,-9.519 7.15,0 -8.07,10.121 c 3.45,0.93 5.36,3.445 5.36,6.852"
                inkscape:connector-curvature="0"
              />
              <path
                id="path38"
