...
const classes = {
  ...
  active: cn(
    'bg-primary-50 font-semibold text-primary-600 dark:bg-primary-500/10',
        ...
        <FocusedItemContext.Provider value={focused}>
          ...
          >
            <div
              className={cn(
                'overflow-y-auto p-4',
                'grow md:h-[calc(100vh-var(--nextra-navbar-height)-var(--nextra-menu-height))]',
                showSidebar ? 'nextra-scrollbar pr-2' : 'no-scrollbar'
              )}
              ref={sidebarRef}
            >
          ...
          >
            ...
            {config.darkMode && (
              <ThemeSwitch
                ...
                className={showSidebar && !hasI18n ? 'grow' : ''}
              />
            )}
